...
Date: 2026-09-23. GPT-OSS uses 64-wide heads, per-head attention sinks, and
alternating sliding-window and full-attention layers. The opt-in `ROCM_SEGMENTED_ATTN`
